	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			GameOverSubstate.characterName = 'bfexe';
				...
				var bg:BGSprite = new BGSprite('mario/EXE1/Brick3', 500, 500, 0.45, 0.45);
				bg.setGraphicSize(Std.int(bg.width * 1.3));
				bg.scale.set(4, 4);
				bg.antialiasing = ClientPrefs.globalAntialiasing;
				add(bg);

				var castillo:BGSprite = new BGSprite('mario/EXE1/Brick4', 500, 500, 0.55, 0.55);
